...
delay = float(1.4) #Can't be smaller than 1 or miss steps. If increase, slows down movements
...
######################### Start movement code.
  ...
  moveLine(.75, 90) # move pour spot to south # temporary adjustment for strong initial pour. 
  ...
  moveLine(.88, 270) #pour to the north # back to 0 north south
  time.sleep (60)
  ...
  moveLine(.625, 202.5) # repeat of above
  moveLine(.88, 270) #pour to north
  moveLine(1.66, 0) #pour to the west
  moveLine(.88, 90) #pour to the south
  moveLine(1.66, 180) #pour to the east
